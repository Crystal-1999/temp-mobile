...
router.get("/app/login",async  (req, res) => {
    ...
    let balance = 0; // Default balance for non-logged-in users
    if (req.customer) {
...
router.get("/about", async (req, res) => {
    res.render("pages/about", { customer: res.locals.customer });
});
...
router.get("/privacy-policy", async (req, res) => {
    res.render("pages/privacy", { customer: res.locals.customer });
});

router.get("/blog", async (req, res) => {
    res.render("pages/blog", { customer: res.locals.customer });
});

router.get("/blog-detail", async (req, res) => {
    res.render("pages/blog-detail", { customer: res.locals.customer });
});
